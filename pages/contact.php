...
<div class="wpcf7" id="wpcf7-f156-p143-o1 formwrap">
  <form action="../sendEmail.php" method="post" class="wpcf7-form" novalidate="novalidate">
    ...
    <p>
      ...
      <span class="wpcf7-form-control-wrap Subject flat">
        <select name="Subject" class="indent wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false">
          <option value="General" id="ok">About Service</option>
          <option value="Booking" id="ok">About Website</option>
        </select>
      </span>
      ...
      <input type="submit" value="Send Feedback" class="wpcf7-form-control wpcf7-submit btn" >
